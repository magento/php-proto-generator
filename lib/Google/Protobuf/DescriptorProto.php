...
class DescriptorProto extends \Google\Protobuf\Internal\Message
{
    ...
    private $oneof_decl;
    /**
     * Generated from protobuf field <code>.google.protobuf.MessageOptions options = 7;</code>
     */
     ...
     *
     *     @type string $name
     *     @type \Google\Protobuf\FieldDescriptorProto[]|\Google\Protobuf\Internal\RepeatedField $field
     *     @type \Google\Protobuf\FieldDescriptorProto[]|\Google\Protobuf\Internal\RepeatedField $extension
     *     @type \Google\Protobuf\DescriptorProto[]|\Google\Protobuf\Internal\RepeatedField $nested_type
     *     @type \Google\Protobuf\EnumDescriptorProto[]|\Google\Protobuf\Internal\RepeatedField $enum_type
     *     @type \Google\Protobuf\DescriptorProto\ExtensionRange[]|\Google\Protobuf\Internal\RepeatedField $extension_range
     *     @type \Google\Protobuf\OneofDescriptorProto[]|\Google\Protobuf\Internal\RepeatedField $oneof_decl
     *     @type \Google\Protobuf\MessageOptions $options
     *     @type \Google\Protobuf\DescriptorProto\ReservedRange[]|\Google\Protobuf\Internal\RepeatedField $reserved_range
    ...
    /**
     * Generated from protobuf field <code>repeated .google.protobuf.DescriptorProto.ExtensionRange extension_range = 5;</code>
     * @param \Google\Protobuf\DescriptorProto\ExtensionRange[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setExtensionRange($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Protobuf\DescriptorProto\ExtensionRange::class);
    ...
    /**
     * Generated from protobuf field <code>repeated .google.protobuf.OneofDescriptorProto oneof_decl = 8;</code>
     * @param \Google\Protobuf\OneofDescriptorProto[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOneofDecl($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Protobuf\OneofDescriptorProto::class);
        $this->oneof_decl = $arr;
    ...
    /**
     * Generated from protobuf field <code>.google.protobuf.MessageOptions options = 7;</code>
     * @param \Google\Protobuf\MessageOptions $var
     * @return $this
     */
    public function setOptions($var)
    {
        GPBUtil::checkMessage($var, \Google\Protobuf\MessageOptions::class);
        $this->options = $var;
    ...
    /**
     * Generated from protobuf field <code>repeated .google.protobuf.DescriptorProto.ReservedRange reserved_range = 9;</code>
     * @param \Google\Protobuf\DescriptorProto\ReservedRange[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setReservedRange($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Protobuf\DescriptorProto\ReservedRange::class);
